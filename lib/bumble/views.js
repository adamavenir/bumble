...
Views.prototype.index = function (req, res) {
    ...
    paginator.paginate(this.postData, req, res, function (realPage) {
        ...
        res.render('index', { 
            ...
            blogSubtitle: postData.blogSubtitle,
            bodyId: 'archive',
            blogTitle: postData.blogTitle,
            blogSubtitle: postData.blogSubtitle,
            blogAuthor: postData.blogAuthor,
            blogAuthorEmail: postData.blogAuthorEmail,
            gravatar: postData.gravatar,
            blogBio: postData.blogBio,
...
Views.prototype.blogMonthIndex = function (req, res) {
    ...
    paginator.paginate(posts, req, res, function (realPage) {
        ...
        logger.info('gravatar', postData.gravatar);
    });
};
