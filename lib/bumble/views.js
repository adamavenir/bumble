...
function Views (config) {
    ...
    blogYearIndex = function (req, res) {
    ...
    blogMonthIndex = function (req, res) {
        var year  = req.params.year,
            month = req.params.month,
            posts = new Array();
    ...
    blogDateIndex = function (req, res) {
        var year  = req.params.year,
            month = req.params.month,
            day   = req.params.day,
            posts = new Array();
...
module.exports = function (config) {
  return new Views(config);
  logger.debug('Views email: ' + util.inspect(config.blogAuthorEmail));
}