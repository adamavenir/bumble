...
function Views(config, done) {
    ...
    function loadPosts(posts) {
        ...
        self.allTags = _.uniq(_.flatten(_.pluck(posts, 'tags')));
    }
...
Views.prototype.tagIndex = function (currentPage, tag, next) {
    var posts;
    posts = this.postData.filter(function _filterPosts(post) {
...
Views.prototype.authorIndex = function (currentPage, authorSlug, next) {
    var posts;
    posts = _.where(this.postData, {authorSlug: authorSlug});
